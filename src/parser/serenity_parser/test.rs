...
#[test_case( "print 5;", false;"print_statement")]
#[test_case( "{ print 5; var i = 5; }", false;"block_statement")]
#[test_case( "if (x > 8) { print 5; }", false;"if_statement")]
#[test_case("while (x > 8) { print 5; }", false;"while_statement")]
#[test_case("for (var i = 0; i < 10; i = i + 1) { print i; }", false;"for_statement")]
